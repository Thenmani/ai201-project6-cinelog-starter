...
def add_to_watchlist(user_id, film_id):
    ...
    Raises:
        ...
        AlreadyInWatchlistError: If the film is already on this user's watchlist.
    """
    ...
    if existing:
        raise AlreadyInWatchlistError(f"Film '{film_id}' is already on this user's watchlist")
...
def get_watchlist(user_id):
    ...
    entries = (
        ...
        .join(Film)
        .order_by(WatchlistEntry.date_added.desc()) # sorting by most-recently added
        .all()
    )
